...
function HomePlateformTiktok() {
  return (
    <section className="relative w-full lg:pt-28 ">
        ...
        <div className="section-wrapper md:flex-row flex flex-col md:px-0 px-4 items-center relative">
          ...
          <div className="md:w-1/2 w-full lg:pr-8 relative">
            <div className="relative z-[5]">
              ...
              />
              <h2 className="sub-title mb-4">Tiktok influencer</h2>
              <p className="mb-4">
                Reach audiences with scroll-stopping TikTok videos created by
                real people, designed to spark engagement and drive results.
              </p>
              <Button
      ...
      <div className="absolute left-1/2 top-1/2 inline-flex radial-blur lg:size-80 z-0"></div>
    </section>
  );
}

export default HomePlateformTiktok;
